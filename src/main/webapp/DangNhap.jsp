            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        ...
                        <form class="log-in-form" action="DangNhap" method="post" id="form">
							...
							data-type="image" data-sitekey="6LeBqMEdAAAAAP7LQ7KxQPQU2MUU77eN6gWeR87g"></div>
                            ...
                            <div class="form-group row text-center mb-0">
                                <div class="col-12">
                                    <div class="border-top">
                                        <a href="DangKy" class="no-account"
                                            >No account? Create one here</a
                                        ><br>
                                        <a href="DangNhapAdmin" class="no-account">Login with admin account? Click Here</a>
                                    </div>
                                </div>
                            </div>
                        </form>

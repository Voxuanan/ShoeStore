    ...
    <body>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="section-title text-center mb-15">
                            <h2 class="title text-dark text-capitalize">Update Shoe</h2>
                        </div>
                    </div>
                    <div class="col-12">
                        <ol
                        ...
                        >
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Update Shoe</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="register pt-80 pb-80">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h3 class="title text-capitalize mb-30 pb-25">Update A Shoe</h3>
                    </div>
                    <div class="col-lg-4 col-md-12 log-in-form">
                        <img id="blah"  src="assets/img/product/<%=thongTinGiay.getAnh()!=null?thongTinGiay.getAnh():"default.png" %>" alt="your image" 
                    ...
                    <div class="col-lg-8 col-md-12 log-in-form">
                        <div>
                           <form method="post" action="SuaGiay?maGiay=<%=thongTinGiay.getMaGiay() %>" enctype= "multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input
                                            ...
                                            class="form-control"
                                            name="soLuongTon"
                                             value="<%=thongTinGiay.getSoLuongTon() %>"
                                        />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    >
                                        ...
                                        <div class="input-group mb-2 mr-sm-2">
                                            <select name="maLoai" class="form-select"
                                                id="categoryId" >
												<% for (Loai l: dsLoai ) {
												if (l.getMaLoai() == thongTinGiay.getMaLoai()){%>
												<option value="<%=l.getMaLoai()%>" selected="selected"> <%=l.getTenLoai()%></<option>
												<%} else {%>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group mb-2 mr-sm-2">
                                            <textarea id="editor" name="moTa"><%=thongTinGiay.getMoTa()%></textarea>
